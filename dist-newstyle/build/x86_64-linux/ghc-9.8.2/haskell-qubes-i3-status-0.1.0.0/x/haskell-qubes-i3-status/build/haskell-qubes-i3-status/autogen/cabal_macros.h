...
/* package haskell-qubes-i3-status-0.1.0.0 */
#ifndef VERSION_haskell_qubes_i3_status
#define VERSION_haskell_qubes_i3_status "0.1.0.0"
#endif /* VERSION_haskell_qubes_i3_status */
#ifndef MIN_VERSION_haskell_qubes_i3_status
#define MIN_VERSION_haskell_qubes_i3_status(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_qubes_i3_status */
...
#define CURRENT_COMPONENT_ID "haskell-qubes-i3-status-0.1.0.0-inplace-haskell-qubes-i3-status"
